    ...
    var colorSection: some View {
        VStack(alignment: .leading, spacing: Theme.Spacing.s40) {
            ...
            ColorGroup(title: "Content > Link", swatches: [
                ...
                (
                    "contrast",
                    Theme.Color.Content.Link.contrast
                ),
                (
                    "disabled",
                    Theme.Color.Content.Link.disabled
                )
            ])
            ...
            ColorGroup(title: "Surface > Overlay", swatches: [
                (
                    "default",
                    Theme.Color.Surface.Overlay.default
                ),
                ("heavy", Theme.Color.Surface.Overlay.heavy)
            ])

            ColorGroup(
                title: "Surface > Skeleton",
                swatches: [
                    (
                        "default",
                        Theme.Color.Surface.Skeleton.default
                    ),
                    (
                        "heavy",
                        Theme.Color.Surface.Skeleton.heavy
                    )
                ]
            )
            ...
            ColorGroup(title: "Status > Info", swatches: [
                ...
                (
                    "disabled",
                    Theme.Color.Status.Info.disabled
                ),
            ...
            ColorGroup(title: "Status > Error", swatches: [
                ...
                (
                    "pressed",
                    Theme.Color.Status.Error.pressed
                ),
                ("text", Theme.Color.Status.Error.text),
                (
                    "disabled",
                    Theme.Color.Status.Error.disabled
                ),
            ...
            ColorGroup(
                ...
                swatches: [
                    ...
                    (
                        "pressed",
                        Theme.Color.Status.Success.pressed
                    ),
                    (
                        "text",
                    ...
                    (
                        "disabled",
                        Theme.Color.Status.Success.disabled
                    ),
                    (
                        "border",
            ...
            ColorGroup(
                ...
                swatches: [
                    ...
                    (
                        "pressed",
                        Theme.Color.Status.Warning.pressed
                    ),
                    (
                        "text",
                    ...
                    (
                        "disabled",
                        Theme.Color.Status.Warning.disabled
                    ),
                    (
                        "border",
                        Theme.Color.Status.Warning.border
                    ),
                    (
                        "subtle",
                        Theme.Color.Status.Warning.subtle
                    )
                ]
            )

            ColorGroup(
                title: "Status > Breaking",
                swatches: [
                    (
                        "resting",
                        Theme.Color.Status.Breaking.resting
                    ),
                    (
                        "pressed",
                        Theme.Color.Status.Breaking.pressed
                    ),
                    (
                        "text",
                        Theme.Color.Status.Breaking.text
                    ),
                    (
                        "disabled",
                        Theme.Color.Status.Breaking.disabled
                    ),
                    (
                        "border",
                        Theme.Color.Status.Breaking.border
                    )
                ]
            )

            SectionHeader(title: "App-Specific Tokens")

            ColorGroup(
                title: "Match > Gradient",
                swatches: [
                    (
                        "purpleStart",
                        Theme.Color.Match.Gradient
                            .purpleStart
                    ),
                    (
                        "purpleEnd",
